...
def main():
    print("=== AGENTIC RAG SYSTEM - PHASE 2 (CORE) ===")
    print("System active. Models: Qwen2.5 & Nomic-Embed")
    
    while True:
        query = input("\nUser Question (or 'exit' to quit): ").strip()
        ...
        print(f"[*] Analyzing domain for: '{query}'...")
        domain = classify_domain(query)
        print(f"[*] Routed to domain: {domain.upper()}")
